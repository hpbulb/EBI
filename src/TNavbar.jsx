        ...
        <nav className="p-4 bg-linear-to-br from-gray-900 to-blue-800  relative ">
                <div className="flex justify-between items-center ">
                    ...
                    <div>
                        ...
                        <li className="text-blue-900 bg-white p-2 rounded-full hover:-translate-x-0.5 transition duration-300 font-semibold inline-flex items-center gap-1 text-sm sm:text-shadow-2xs"><Link to="/student-portal" className="inline-flex items-center gap-2"><FontAwesomeIcon icon={faUser} className="text-blue text-md" />Student Portal</Link></li>
                        <li className="text-blue-900 bg-white p-2 rounded-full hover:-translate-x-0.5 transition duration-300 font-semibold inline-flex items-center gap-1 text-sm sm:text-shadow-2xs"> <FontAwesomeIcon icon={faFile} className="text-blue-900 text-md" /><Link to="/registration">Apply Now</Link></li>
                    </ul>
                    </div>
                </div>
            </nav>
