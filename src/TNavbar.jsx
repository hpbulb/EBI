        ...
        <nav className="p-4 bg-linear-to-br from-gray-900 to-blue-800  relative ">
                <div className="flex justify-between items-center ">
                    ...
                    <div>
                        ...
                        <li className="text-blue-900 bg-white p-2 rounded-full hover:-translate-x-0.5 transition duration-300 font-semibold inline-flex items-center gap-1 text-sm"><Link to="/student-portal" className="inline-flex items-center gap-2"><FontAwesomeIcon icon={faUser} className="text-blue text-md" />Student Portal</Link></li>
